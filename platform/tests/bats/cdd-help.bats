...
@test "cdd help lists project commands with grey descriptions" {
  ...
  assert_output_contains "features:create ${esc}[37m- create a feature plan and open it in the editor${esc}[0m"
  assert_output_contains "problems:create ${esc}[37m- create a problem plan and open it in the editor${esc}[0m"
...
@test "cdd self-help lists cdd subcommands" {
  ...
  assert_output_contains "cdd problems:create ${esc}[37m- create a problem plan and open it in the editor${esc}[0m"

  ...
  [
    ...
    { kind: 'definition', value: 'the ontology being viewed.' },
    {
      ...
      value: [
        ...
        'cdd.command',
        'cdd.concept',
        'cdd.conceptDrivenDirectoryStructure',
        'cdd.conceptualSystem',
        'cdd.containers',
        'cdd.context',
        'cdd.contradiction',
        'cdd.database',
        'cdd.dependencyInjection',
        'cdd.developer',
        'cdd.directory',
        'cdd.display',
        'cdd.diversity',
        ...
        'cdd.symlinks',
        'cdd.tests',
        'cdd.theProjectFileHierarchyProblem',
        'cdd.tool',
        'cdd.toolDrivenDirectoryStructure',
        'cdd.transaction',
        'cdd.user',
        'cdd.virtualReality',
      ],
    },
    { kind: 'ontologyDiagram', value: 'cdd' },
  ],
  [

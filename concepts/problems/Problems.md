Problem - a part of the current state of a reality that we want to change

Every project has a problem it solves, which is the reason a project exists
...
Usually different kinds of problems are solved for different kinds of stakeholders in a project. So there are almost always multiple problems being solved per project

# Examples

Twitter (or basically any social network):

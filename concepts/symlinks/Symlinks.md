...
CDD is based on a hierarchy represented by the file system. But oftentimes you want the same file in multiple places, because it belongs to all those places, but that would violate the hierarchy. Symlinks to the rescue!
